							...
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.php">Bella Toes </a>
										</h4>
						...
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.php">Chikku Loafers </a>
										</h4>
										<div class="info-product-price">
											<div class="grid_meta">
												<div class="product_price">
						...
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.php">(SRV) Sneakers </a>
										</h4>
										<div class="info-product-price">
											<div class="grid_meta">
												<div class="product_price">
						...
						<div class="col-md-4 product-men women_two">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.php">Catwalk Flats</a>
										</h4>
										<div class="info-product-price">
											<div class="grid_meta">
												<div class="product_price">
						...
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.php">Bank Sneakers</a>
										</h4>
										<div class="info-product-price">
											<div class="grid_meta">
												<div class="product_price">
